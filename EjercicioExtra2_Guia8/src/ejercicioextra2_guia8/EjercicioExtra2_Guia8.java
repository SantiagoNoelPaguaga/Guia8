 ...
 */
public class EjercicioExtra2_Guia8 {

    /**
     * @param args the command line arguments
     * Dígito Verificador. Crear una
     * clase NIF que se usará para mantener DNIs con su correspondiente letra
     * (NIF). Los atributos serán el número de DNI (entero largo) y la letra
     * (String o char) que le corresponde. En NIFService se dispondrá de los
     * siguientes métodos: a) Métodos getters y setters para el número de DNI y
     * la letra. b) Método crearNif(): le pide al usuario el DNI y con ese DNI
     * calcula la letra que le corresponderá. Una vez calculado, le asigna la
     * letra que le corresponde según c) Método mostrar(): que nos permita
     * mostrar el NIF (ocho dígitos, un guion y la letra en mayúscula; por
     * ejemplo: 00395469-F). La letra correspondiente al dígito verificador se
